          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <SidebarItem 
                ...
                title="Category"
                icon={
                  <svg className="shrink-0" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M2 2h4v4H2V2zm0 6h4v4H2V8zm6-6h4v4H8V2zm0 6h4v4H8V8z"/>
                ...
                subMenuItems={[
                  ...
                  },
                  {
                    ...
                    onClick: () => onShowCategories && onShowCategories('categoryForm'),
                    isActive: Boolean(onShowCategories),
                    ariaLabel: "Categories menu"
                  }
                ]}
              ...
              <SidebarItem 
                ...
                title="Products"
                icon={
                  <svg className="shrink-0" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                ...
                subMenuItems={[
                  ...
                  },
                  {
                    ...
                    onClick: () => onShowProducts && onShowProducts('productForm'),
                    isActive: Boolean(onShowProducts),
                    ariaLabel: "Products menu"
                  }
                ]}
              ...
              <SidebarItem 
                ...
                subMenuItems={[
                  ...
                  },
                  {
                    ...
                    onClick: () => onShowPermissions && onShowPermissions('permissionForm'),
                    isActive: Boolean(onShowPermissions),
                    ariaLabel: "Permissions menu"
                  }
                ]}
